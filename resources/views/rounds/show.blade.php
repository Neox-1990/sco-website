      ...
      <table class="table table-bordered table-striped table-hover" id="round-sessions-table">
        @if (!is_null($times['fp1']))
          <tr>
            ...
            <td><i class="fas fa-calendar-alt mr-3 d-none d-md-inline" aria-hidden="true"></i><span class="d-none d-lg-inline">{{$times['fp1']->format('l jS \\of F Y H:i (e)')}}</span><span class="d-inline d-lg-none">{{$times['fp1']->format('Y-m-d H:i')}}</span></td>
        ...
        @if (!is_null($times['fp2']))
          <tr>
            ...
            <td><i class="fas fa-calendar-alt mr-3 d-none d-md-inline" aria-hidden="true"></i><span class="d-none d-lg-inline">{{$times['fp2']->format('l jS \\of F Y H:i (e)')}}</span><span class="d-inline d-lg-none">{{$times['fp2']->format('Y-m-d H:i')}}</span></td>
        ...
        @if (!is_null($times['fp3']))
          <tr>
            ...
            <td><i class="fas fa-calendar-alt mr-3 d-none d-md-inline" aria-hidden="true"></i><span class="d-none d-lg-inline">{{$times['fp3']->format('l jS \\of F Y H:i (e)')}}</span><span class="d-inline d-lg-none">{{$times['fp3']->format('Y-m-d H:i')}}</span></td>
        ...
        <tr>
          ...
          <td><i class="fas fa-calendar-alt mr-3 d-none d-md-inline" aria-hidden="true"></i><span class="d-none d-lg-inline">{{$times['wup']->format('l jS \\of F Y H:i (e)')}}</span><span class="d-inline d-lg-none">{{$times['wup']->format('Y-m-d H:i')}}</span></td>
        ...
        <tr>
          ...
          <td><i class="fas fa-calendar-alt mr-3 d-none d-md-inline" aria-hidden="true"></i><span class="d-none d-lg-inline">{{$times['q']->format('l jS \\of F Y H:i (e)')}}</span><span class="d-inline d-lg-none">{{$times['q']->format('Y-m-d H:i')}}</span></td>
          <td><i class="fas fa-stopwatch mr-3 d-none d-md-inline" aria-hidden="true"></i>{{$round->qual_minutes}} min</td>
        </tr>
        <tr>
          <th>Race</th>
          <td><i class="fas fa-calendar-alt mr-3 d-none d-md-inline" aria-hidden="true"></i><span class="d-none d-lg-inline">{{$times['r']->format('l jS \\of F Y H:i (e)')}}</span><span class="d-inline d-lg-none">{{$times['r']->format('Y-m-d H:i')}}</span></td>
