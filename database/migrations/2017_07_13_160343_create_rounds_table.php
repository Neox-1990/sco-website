...
class CreateRoundsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('rounds', function (Blueprint $table) {
            ...
            $table->dateTime('fp1_insimdate')->nullable();
            $table->integer('fp1_minutes')->nullable();
            $table->dateTime('fp2_start')->nullable();
            $table->dateTime('fp2_insimdate')->nullable();
            $table->integer('fp2_minutes')->nullable();
            $table->dateTime('fp3_start')->nullable();
            $table->dateTime('fp3_insimdate')->nullable();
            $table->integer('fp3_minutes')->nullable();
            $table->dateTime('warmup_start')->nullable();
            $table->dateTime('warmup_insimdate')->nullable();
            $table->integer('warmup_minutes')->nullable();
            $table->dateTime('qual_start')->nullable();
            $table->dateTime('qual_insimdate')->nullable();
            $table->integer('qual_minutes')->nullable();
            $table->dateTime('race_start')->nullable();
            $table->dateTime('race_insimdate')->nullable();
