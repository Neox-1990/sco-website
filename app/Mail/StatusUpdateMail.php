...
class StatusUpdateMail extends Mailable
{
    ...
    public function build()
    {
        ...
        case 2:
          ...
          break;
        case 3:
          $info['html'] = '<p>Your team is qualified for the season. To get confirmed you now have to pay the season entry fee of $25. You can use the following paypal.me link to pay the fee:<br><br><a href="https://www.paypal.me/sportscaropen/25usd">https://www.paypal.me/sportscaropen/25usd</a><br><br><b>Make sure to send a note with your payment, so we know what team/car/entry that payment is meant for!</b></p>';
          $info['text'] = 'Your team is qualified for the season. To get confirmed you now have to pay the season entry fee of $25. You can use the following paypal.me link to pay the fee:

https://www.paypal.me/sportscaropen/25usd
